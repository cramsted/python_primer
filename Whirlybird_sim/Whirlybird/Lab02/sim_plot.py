...
class plotGenerator:
    ...
    def __init__(self):
        ...
        # Section 2
        ####################################################################
        degreeConvert = 180.0/np.pi
        self.handle.append(myPlot(self.ax[0], degreeConvert,'t(s)', 'theta',
                                 'theta_r/theta'))
        self.handle.append(myPlot(self.ax[1], degreeConvert,'t(s)','phi',
                                 'phi_r/phi'))
        self.handle.append(myPlot(self.ax[2], degreeConvert,'t(s)', 'psi',
                                 'psi_r/psi'))
    ...
    def update_plot(self,time_history):
        ...
        if self.init == True:
            ...
            for i in range(size):
                ...
                self.line.append(Line2D(time_history,list(data)[i],
